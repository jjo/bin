...
ambito() {
	curl -s http://www.ambito.com/economia/mercados/monedas/dolar/|egrep -o '(OFICIAL|INFORMAL)|[0-9]+,[0-9]+.*(COMPRA|VENTA)'|xargs -l3|sed -rn 's/,/./g;s/(^[A-Z]+) ([0-9.]+)<.*(COMPRA).* ([0-9.]+)<.*(VENTA)/\L\1.\L\3 \2\n\L\1.\L\5 \4/gp'
}
